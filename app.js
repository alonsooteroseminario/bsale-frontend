...
const fetchDataProductsByName = async (name) => {
    const res = await fetch(`/${BACKEND_URL}/api/productos?name=${name}`);
    const data = await res.json()
    pintarCards(data)
}
...
const fetchDataProductsByCategory = async (category) => {
    const res = await fetch(`/${BACKEND_URL}/api/productos/${category}`);
    const data = await res.json()
    pintarCards(data)
}
...
const fetchCategoryIdByName = async (category) => {
    const res = await fetch(`/${BACKEND_URL}/api/categorias/${category}`);
    const data = await res.json()
    return data.id;
}
